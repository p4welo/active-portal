...
public interface PublicApiMappings
{
   ...
   public static final String GET_CLASSES = PUBLIC_PREFIX + "/course";

   public static final String GET_FUTURE_CLASSES = PUBLIC_PREFIX + "/course/registration";
   ...
   public static final String GET_CATEGORIES = PUBLIC_PREFIX + "/category/list";

   public static final String GET_INSTRUCTORS = PUBLIC_PREFIX + "/instructor/list";
