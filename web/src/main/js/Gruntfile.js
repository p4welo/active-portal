module.exports = function (grunt) {
    ...
    var taskConfig = {
                ...
                files: [
                    {
                        src: ['fonts/**/*.*'],
                        dest: '<%= build_dir %>/assets/',
                        cwd: 'vendor/proui/css/',
                        expand: true
                    },
                    {
                        src: ['fonts/**/*.*'],
                        dest: '<%= build_dir %>/vendor/proui/css/',
                        cwd: 'vendor/proui/css/',
                        expand: true
                    }
                ]
        ...
        html2js: {
            ...
            app: {
                ...
                src: ['<%= app_files.atpl %>'],
                dest: '<%= build_dir %>/assets/templates-app.js'
            }
        },
        ...
        htmlmin: {
            compile: {
                ...
                files: {
                    '<%= pages_dir %>/home.html': '<%= pages_dir %>/home.html',
                    '<%= pages_dir %>/index.html': '<%= pages_dir %>/index.html',
                    '<%= pages_dir %>/login.html': '<%= pages_dir %>/login.html'
                }
            }
        },
    ...
    grunt.registerMultiTask('index', 'Process index.html template', function () {
        ...
        grunt.file.copy('src/home.html', this.data.dir + '/home.html', {
