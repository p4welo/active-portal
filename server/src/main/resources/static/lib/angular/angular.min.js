...
(function (Y, O, r) {
        ...
        return b.module || (b.module = function () {
            ...
            return function (e, g, f) {
                ...
                return b[e] || (b[e] = function () {
                    ...
                    var c = [], d = [], m = b("$injector", "invoke"), n = {_invokeQueue: c, _runBlocks: d, requires: g, name: e, provider: b("$provide", "provider"), factory: b("$provide", "factory"), service: b("$provide", "service"), value: b("$provide", "value"), constant: b("$provide", "constant", "unshift"), animation: b("$animateProvider", "register"), filter: b("$filterProvider",
                        "register"), controller: b("$controllerProvider", "register"), directive: b("$compileProvider", "directive"), config: m, run: function (a) {
                        d.push(a);
                        return this
                    }};
                    f && m(f);
    ...
    function Yb(b) {
        ...
        var f = {}, h = "Provider", l = [], k = new Ra, m = {$provide: {provider: a(c), factory: a(d), service: a(function (a, b) {
            ...
            "$$sanitizeUri", function (a, b, m, n, p, t, w, A, F, H, S, z) {
                ...
                function ga(a, c, d, e, g, f, l, p, n) {
                    ...
                    function W(a, e, g, f, n) {
                        ...
                        s = n && A;
                        H && q(H, function (a) {
                            var b = {$scope: a === z || a.$$isolateScope ? Q : e, $element: B, $attrs: K, $transclude: s}, c;
                            R = a.controller;
                            "@" == R && (R = K[a.name]);
                            c = w(R, b);
                            eb[a.name] = c;
                    ...
                    for (var T = !1, D = !1, x = d.$$element = u(c), G, ba, s, N = e, ma, L = 0, Fa = a.length; L < Fa; L++) {
                        ...
                        if (G.templateUrl)C("template", ga, G, x), ga = G, G.replace && (f = G), W = y(a.splice(L, a.length - L), x, d, g, N, l, p, {controllerDirectives: H, newIsolateScopeDirective: z, templateDirective: ga, nonTlbTranscludeDirective: n}),
                ...
                function y(a, b, c, d, e, g, f, l) {
                    var k = [], m, t, w = b[0], A = a.shift(),
                        B = x({}, A, {templateUrl: null, transclude: null, replace: null, $$originalDirective: A}), S = J(A.templateUrl) ? A.templateUrl(b, c) : A.templateUrl;
                    b.empty();
    ...
    function kd() {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, b, c, d, n, p) {
            ...
            q(f, function (a, b) {
                ...
                H.splice(b, 0, {response: function (a) {
                    return c(n.when(a))
    ...
    function yd(b, a) {
        ...
        var e = function () {
            ...
            return a && J(a.then) ? a : {then: function (c) {
                var d = e();
                b(function () {
                    d.resolve(c(a))
                });
        ...
        return{defer: e, reject: f, when: function (h, l, k, m) {
    ...
    function zd() {
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser", function (d, e, g, f) {
            ...
            h.prototype = {constructor: h, $new: function (a) {
                ...
                }, defaultPrevented: !1}, l = [h].concat(ua.call(arguments, 1)), k, m;
                do {
                    d = f.$$listeners[a] || c;
                    h.currentScope = f;
                    k = 0;
                ...
                var c = this, d = this, f = {name: a, targetScope: this, preventDefault: function () {
    ...
    function Ed() {
        this.$get = ["$window", "$document", function (b, a) {
            ...
            return{history: !(!b.history || !b.history.pushState || 4 > d || e), hashchange: "onhashchange"in b && (!f || 7 < f), hasEvent: function (a) {
                ...
                return c[a]
            }, csp: Sb(), vendorPrefix: h, transitions: m, animations: n, android: d, msie: L, msieDocumentMode: f}
        }]
    }
    ...
    var Sc = /[A-Z]/g, Qd = {full: "1.2.6", major: 1, minor: 2, dot: 6, codeName: "taco-salsafication"}, Qa = N.cache = {}, bb = N.expando = "ng-" + (new Date).getTime(), Wc = 1, Hc = Y.document.addEventListener ? function (b, a, c) {
    ...
    }, Uc = /([\:\-\_]+(.))/g, Vc = /^moz([A-Z])/, wb = s("jqLite"), Da = N.prototype = {ready: function (b) {
        function a() {
            c || (c = !0, b())
        }
    ...
    }, length: 0, push: Pd, sort: [].sort, splice: [].splice}, db = {};
    ...
    q({removeData: Zb, dealoc: Ba, on: function a(c, d, e, g) {
        ...
        find: function (a, c) {
            ...
            d = d || [];
            var e = [
                {preventDefault: y, stopPropagation: y}
            ];
            q(c, function (c) {
    ...
    }, nc = s("$interpolate"), Td = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, rd = {http: 80, https: 443, ftp: 21}, Gb = s("$location");
    sc.prototype = Hb.prototype = rc.prototype = {$$html5: !1, $$replace: !1, absUrl: gb("$$absUrl"),
        url: function (a, c) {
    ...
    var xa = s("$parse"), wc = {}, qa, Ia = {"null": function () {
        return null
    }, "true": function () {
        return!0
    }, "false": function () {
    ...
    var Ib = {}, ra = s("$sce"), da = {HTML: "html", CSS: "css", URL: "url", RESOURCE_URL: "resourceUrl", JS: "js"}, X = O.createElement("a"), yc = pa(Y.location.href, !0);
    zc.$inject = ["$provide"];
    Ac.$inject = ["$locale"];
    Cc.$inject = ["$locale"];
    var Fc = ".", Od = {yyyy: U("FullYear", 4), yy: U("FullYear", 2, 0, !0), y: U("FullYear", 1),
            MMMM: ib("Month"), MMM: ib("Month", !0), MM: U("Month", 2, 1), M: U("Month", 1, 1), dd: U("Date", 2), d: U("Date", 1), HH: U("Hours", 2), H: U("Hours", 1), hh: U("Hours", 2, -12), h: U("Hours", 1, -12), mm: U("Minutes", 2), m: U("Minutes", 1), ss: U("Seconds", 2), s: U("Seconds", 1), sss: U("Milliseconds", 3), EEEE: ib("Day"), EEE: ib("Day", !0), a: function (a, c) {
    ...
    var Kd = Z(C), Ld = Z(Ga);
    Dc.$inject = ["$parse"];
    var Vd = Z({restrict: "E", compile: function (a, c) {
    ...
    var Ic = function (a) {
            return["$timeout", function (c) {
                return{name: "form", restrict: a ? "EAC" : "E", controller: Gc, compile: function () {
        ...
        }, Wd = Ic(), Xd = Ic(!0), Yd = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, Zd = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,6}$/, $d = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Jc = {text: nb, number: function (a, c, d, e, g, f) {
            nb(a, c, d, e, g, f);
        ...
        }, hidden: y, button: y, submit: y, reset: y}, Kc = ["$browser", "$sniffer", function (a, c) {
            ...
            return{require: ["ngModel", "^?form"], controller: ae, link: function (a, c, d, e) {
                var g = e[0], f = e[1] || lb;
                f.$addControl(g);
        ...
        }, ce = Z({require: "ngModel", link: function (a, c, d, e) {
        ...
        }], je = Lb("", !0), ke = Lb("Odd", 0), le = Lb("Even", 1), me = sa({compile: function (a, c) {
            c.$set("ngCloak", r);
    ...
    var oe = ["$animate", function (a) {
            ...
            return{restrict: "ECA", priority: 400, terminal: !0, transclude: "element", controller: Na.noop, compile: function (f, h) {
        ...
        }], re = sa({priority: 450, compile: function () {
            ...
            var d = s("ngRepeat");
            return{transclude: "element", priority: 1E3, terminal: !0, $$tlb: !0, link: function (e, g, f, h, l) {
        ...
        }], ze = sa({transclude: "element", priority: 800, require: "^ngSwitch", compile: function (a, c) {
        ...
        }}), Be = sa({controller: ["$element", "$transclude", function (a, c) {
            ...
            return{restrict: "E", require: ["select", "?ngModel"], controller: ["$element", "$scope", "$attrs", function (a, c, d) {
                ...
                function n(e, f, g) {
                    function h() {
                        ...
                        t || (A || null === s ? a[""].unshift({id: "", label: "", selected: !r}) : r || a[""].unshift({id: "?", label: "",
                            selected: !0}));
                        K = 0;
                        for (B = c.length; K < B; K++) {
                            d = c[K];
                            k = a[d];
                            y.length <= K ? (s = {element: E.clone().attr("label", d), label: k.label}, w = [s], y.push(w), f.append(s.element)) : (w = y[K], s = w[0], s.label != d && s.element.attr("label", s.label = d));
                            F = null;
                            z = 0;
                            for (D = k.length; z < D; z++)r = k[z], (d = w[z + 1]) ? (F = d.element, d.label !== r.label && F.text(d.label = r.label), d.id !== r.id && F.val(d.id = r.id), F[0].selected !== r.selected && F.prop("selected", d.selected = r.selected)) : ("" === r.id && A ? J = A : (J = C.clone()).val(r.id).attr("selected", r.selected).text(r.label),
                                w.push({element: J, label: r.label, id: r.id, selected: r.selected}), F ? F.after(J) : s.element.append(J), F = J);
    ...
    (Aa = Y.jQuery) ? (u = Aa, x(Aa.fn, {scope: Da.scope, isolateScope: Da.isolateScope, controller: Da.controller, injector: Da.injector, inheritedData: Da.inheritedData}), vb("remove", !0, !0, !1), vb("empty", !1, !1, !1), vb("html", !1, !1, !0)) : u = N;
    Na.element = u;
    (function (a) {
        x(a, {bootstrap: Xb,
            copy: ea, extend: x, equals: ta, element: u, forEach: q, injector: Yb, noop: y, bind: qb, toJson: oa, fromJson: Tb, identity: za, isUndefined: D, isDefined: v, isString: E, isFunction: J, isObject: V, isNumber: pb, isElement: Oc, isArray: I, version: Qd, isDate: Ja, lowercase: C, uppercase: Ga, callbacks: {counter: 0}, $$minErr: s, $$csp: Sb});
        Ta = Tc(Y);
        try {
            Ta("ngLocale")
        } catch (c) {
