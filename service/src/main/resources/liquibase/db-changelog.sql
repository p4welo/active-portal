...
INSERT INTO style (sid, name, category_id) VALUES
  ('43632299f3434e0889vjkb50c1168103', 'Aktywne 50+', (SELECT
                                                         id
                                                       FROM category
                                                       WHERE code = 'seniorzy')),
  ('43632299f343445289vjkb50c1168103', 'Balet z elementami gimnastyki artystycznej', (SELECT
                                                                                        id
                                                                                      FROM category
                                                                                      WHERE code = 'dzieci')),
  ('43223299f343445289vjkb50c1168103', 'Taniec towarzyski', (SELECT
                                                               id
                                                             FROM category
                                                             WHERE code = 'pary')),
  ('43223299f343445289vjkb0011168103', 'Taniec użytkowy', (SELECT
                                                             id
                                                           FROM category
                                                           WHERE code = 'pary')),
  ('43223369f343445289vjkb0011168103', 'Dziecięca formacja taneczna', (SELECT
                                                                         id
                                                                       FROM category
                                                                       WHERE code = 'formacje')),
  ('43223mcnv343445289vjkb0011168103', 'Hip hop', (SELECT
                                                     id
                                                   FROM category
                                                   WHERE code = 'solo')),
  ('43223mcnv343445289vjkb0585168103', 'Reggaeton', (SELECT
                                                       id
                                                     FROM category
                                                     WHERE code = 'solo')),
  ('43223mcnv343445289vjkb05851yyv03', 'Trening El-Fuego', (SELECT
                                                              id
                                                            FROM category
                                                            WHERE code = 'formacje')),
  ('43223mcnv343445289vjkb05vvvcxv03', 'Hip hop dla dzieci 5-7 lat', (SELECT
                                                                        id
                                                                      FROM category
                                                                      WHERE code = 'dzieci')),
  ('43223mcnv343445289vjkb05ggvcxv03', 'Mix dance 4-7 lat', (SELECT
                                                               id
                                                             FROM category
                                                             WHERE code = 'dzieci')),
  ('53223mcnv343445289vjkb05ggvcxv03', 'Ladies latino', (SELECT
                                                           id
                                                         FROM category
                                                         WHERE code = 'solo')),
  ('53223mcnv34344vb89vjkb05ggvcxv03', 'Salsa solo', (SELECT
                                                        id
                                                      FROM category
                                                      WHERE code = 'solo')),
  ('53223mcnv34344vb89vjgh05ggvcxv03', 'Bachata', (SELECT
                                                     id
                                                   FROM category
                                                   WHERE code = 'pary')),
  ('53223mcnv34344vb89vjgh05hjvcxv03', 'Balet 3 latki', (SELECT
                                                           id
                                                         FROM category
                                                         WHERE code = 'dzieci')),
  ('5322tycnv34344vb89vjgh05hjvcxv03', 'Salsa kubańska', (SELECT
                                                            id
                                                          FROM category
                                                          WHERE code = 'pary')),
  ('5322tycnv34344vb89vjgh05hjvc1233', 'Zouk', (SELECT
                                                  id
                                                FROM category
                                                WHERE code = 'pary'));
...
INSERT INTO dance_class (sid, style_id, instructor_id, day, start_time, end_time, can_join, can_register, in_progress, level, room_id)
VALUES
  ('536789cnv34344vb89vjgh05hjvclakk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43632299f3434e0889vjkb50c1168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'),
   0, '11:00', '12:00', FALSE, FALSE, TRUE, 'BEGINNER', (SELECT
                                                           id
                                                         FROM room
                                                         WHERE name = 'd')),
  ('736dd9cnv34344vb89vjgh05hjvclakk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43632299f3434e0889vjkb50c1168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'), 0, '12:00', '13:00', FALSE, TRUE, FALSE, 'BEGINNER', (SELECT
                                                                                                                                                                                             id
                                                                                                                                                                                           FROM
                                                                                                                                                                                             room
                                                                                                                                                                                           WHERE
                                                                                                                                                                                             ...
                                                                                                                                                                                             =
                                                                                                                                                                                             'd')),
  ('936789cnv34344vb89vjgh05hjvclakk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43632299f343445289vjkb50c1168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv11389vb89vjgh05hjvc8763'), 0, '17:00', '17:45', FALSE, FALSE, TRUE, 'BEGINNER', (SELECT
                                                                                                                                                                                             id
                                                                                                                                                                                           FROM
                                                                                                                                                                                             room
                                                                                                                                                                                           WHERE
                                                                                                                                                                                             ...
                                                                                                                                                                                             =
                                                                                                                                                                                             'd')),
  ('5367czcnv34344vb89vjgh05hjvclakk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223299f343445289vjkb50c1168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv65488vb110jgh05hjvcvv63'), 0, '18:30', '19:30', TRUE, FALSE, TRUE, 'ADVANCED', (SELECT
                                                                                                                                                                                            id
                                                                                                                                                                                          FROM
                                                                                                                                                                                            room
                                                                                                                                                                                          WHERE
                                                                                                                                                                                            ...
                                                                                                                                                                                            =
                                                                                                                                                                                            'd')),
  ('736789hnv34344vb89vjgh05hjvclakk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223299f343445289vjkb0011168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'), 0, '19:30', '20:30', TRUE, FALSE, TRUE, 'INTERMEDIATE', (SELECT
                                                                                                                                                                                                id
                                                                                                                                                                                              FROM
                                                                                                                                                                                                room
                                                                                                                                                                                              WHERE
                                                                                                                                                                                                ...
                                                                                                                                                                                                =
                                                                                                                                                                                                'd')),
  ('336789hnv34344v1166jgh0jkjvclakk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223299f343445289vjkb0011168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'), 0, '20:30', '21:30', FALSE, TRUE, FALSE, 'BEGINNER', (SELECT
                                                                                                                                                                                             id
                                                                                                                                                                                           FROM
                                                                                                                                                                                             room
                                                                                                                                                                                           WHERE
                                                                                                                                                                                             ...
                                                                                                                                                                                             =
                                                                                                                                                                                             'd')),
  ('436789hnv3434jj1166jgh05hjvclakk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223299f343445289vjkb0011168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'), 0, '21:30', '22:30', TRUE, FALSE, TRUE, 'BEGINNER', (SELECT
                                                                                                                                                                                            id
                                                                                                                                                                                          FROM
                                                                                                                                                                                            room
                                                                                                                                                                                          WHERE
  ...
  ('536789hnv3434jj1214jgh05hjvnbvkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223369f343445289vjkb0011168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'), 1, '17:30', '18:30', TRUE, FALSE, TRUE, 'INTERMEDIATE', (SELECT
                                                                                                                                                                                                id
                                                                                                                                                                                              FROM
                                                                                                                                                                                                room
                                                                                                                                                                                              WHERE
                                                                                                                                                                                                ...
                                                                                                                                                                                                =
                                                                                                                                                                                                'd')),
  ('ghj789hnv3434jj1166jgh043jvnbvkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223mcnv343445289vjkb0011168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv11389vb89vjgh05hjvc1233'), 1, '18:30', '19:30', TRUE, FALSE, TRUE, 'BEGINNER', (SELECT
                                                                                                                                                                                            id
                                                                                                                                                                                          FROM
                                                                                                                                                                                            room
                                                                                                                                                                                          WHERE
                                                                                                                                                                                            ...
                                                                                                                                                                                            =
                                                                                                                                                                                            'd')),
  ('aaj789hnv3434jj1166jt55hjtvnbvkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223299f343445289vjkb0011168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'), 1, '18:45', '19:45', FALSE, FALSE, TRUE, 'ADVANCED', (SELECT
                                                                                                                                                                                             id
                                                                                                                                                                                           FROM
                                                                                                                                                                                             room
                                                                                                                                                                                           WHERE
                                                                                                                                                                                             ...
                                                                                                                                                                                             =
                                                                                                                                                                                             'm')),
  ('aaj789hnv3434jj1166jgvbnxzvnbvkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223299f343445289vjkb0011168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv11389vb89vjgh05hjvc8763'), 1, '20:00', '21:00', TRUE, FALSE, TRUE, 'INTERMEDIATE', (SELECT
                                                                                                                                                                                                id
                                                                                                                                                                                              FROM
                                                                                                                                                                                                room
                                                                                                                                                                                              WHERE
                                                                                                                                                                                                ...
                                                                                                                                                                                                =
                                                                                                                                                                                                'd')),
  ('fgtr89hnv3434jj1166jgvbngzvnbvkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223mcnv343445289vjkb0585168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv11389vb110jgh05hjvc8763'), 1, '21:00', '22:00', FALSE, TRUE, FALSE, 'BEGINNER', (SELECT
                                                                                                                                                                                             id
                                                                                                                                                                                           FROM
                                                                                                                                                                                             room
                                                                                                                                                                                           WHERE
                                                                                                                                                                                             ...
                                                                                                                                                                                             =
                                                                                                                                                                                             'd')),
  ('abcd89hnv3434jj1166jgvbnxzvnbvkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223mcnv343445289vjkb05851yyv03'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'), 1, '21:30', '24:00', FALSE, FALSE, TRUE, 'ADVANCED', (SELECT
                                                                                                                                                                                             id
                                                                                                                                                                                           FROM
                                                                                                                                                                                             room
                                                                                                                                                                                           WHERE
  ...
  ('bvgh89hnv3434jj1166jgvbnxzvczvkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid =
                                              '43223mcnv343445289vjkb05vvvcxv03'), NULL, 2, '17:00', '18:00', FALSE, TRUE, FALSE, 'BEGINNER', (SELECT
                                                                                                                                                 id
                                                                                                                                               FROM
                                                                                                                                                 room
                                                                                                                                               WHERE
                                                                                                                                                 ...
                                                                                                                                                 =
                                                                                                                                                 'd')),
  ('kvlb89hnv3434jj1166jgvbnxzwqbvkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223mcnv343445289vjkb05ggvcxv03'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv11389vb110jgh05hjvc8763'), 2, '17:00', '18:00', FALSE, TRUE, FALSE, 'BEGINNER', (SELECT
                                                                                                                                                                                             id
                                                                                                                                                                                           FROM
                                                                                                                                                                                             room
                                                                                                                                                                                           WHERE
                                                                                                                                                                                             ...
                                                                                                                                                                                             =
                                                                                                                                                                                             'm')),
  ('kvlbsdfgv3434jj1166jgvbrezvnbvkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '53223mcnv343445289vjkb05ggvcxv03'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'), 2, '19:30', '20:30', TRUE, FALSE, TRUE, 'BEGINNER', (SELECT
                                                                                                                                                                                            id
                                                                                                                                                                                          FROM
                                                                                                                                                                                            room
                                                                                                                                                                                          WHERE
                                                                                                                                                                                            ...
                                                                                                                                                                                            =
                                                                                                                                                                                            'd')),
  ('hxlbsdfgv3434jj1166jgvbnxzvnbvkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223299f343445289vjkb0011168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv11389vb89vjgh05hjvc8763'), 2, '19:30', '20:30', TRUE, FALSE, TRUE, 'BEGINNER', (SELECT
                                                                                                                                                                                            id
                                                                                                                                                                                          FROM
                                                                                                                                                                                            room
                                                                                                                                                                                          WHERE
                                                                                                                                                                                            ...
                                                                                                                                                                                            =
                                                                                                                                                                                            'm')),
  ('qwebsdfgv3434jj1166jgvbnxnnvbvkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '53223mcnv34344vb89vjkb05ggvcxv03'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'), 2, '19:30', '20:30', TRUE, FALSE, TRUE, 'ADVANCED', (SELECT
                                                                                                                                                                                            id
                                                                                                                                                                                          FROM
                                                                                                                                                                                            room
                                                                                                                                                                                          WHERE
                                                                                                                                                                                            ...
                                                                                                                                                                                            =
                                                                                                                                                                                            'd')),
  ('452fsdfgv3434jj1166jgvbnxzdfbvkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid =
                                              '43223299f343445289vjkb0011168103'), NULL, 2, '20:30', '21:30', FALSE, TRUE, FALSE, 'BEGINNER', (SELECT
                                                                                                                                                 id
                                                                                                                                               FROM
                                                                                                                                                 room
                                                                                                                                               WHERE
  ...
  ('qwebsdfgv34vbhyt166jgvbnxzvnnkkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223299f343445289vjkb0011168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'), 2, '21:30', '22:30', TRUE, FALSE, TRUE, 'ADVANCED', (SELECT
                                                                                                                                                                                            id
                                                                                                                                                                                          FROM
                                                                                                                                                                                            room
                                                                                                                                                                                          WHERE
                                                                                                                                                                                            ...
                                                                                                                                                                                            =
                                                                                                                                                                                            'd')),
  ('qwebsdfgv34vbh64756jgvbnxzvnnkkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223mcnv343445289vjkb05ggvcxv03'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'), 3, '16:30', '17:15', TRUE, FALSE, TRUE, 'BEGINNER', (SELECT
                                                                                                                                                                                            id
                                                                                                                                                                                          FROM
                                                                                                                                                                                            room
                                                                                                                                                                                          WHERE
                                                                                                                                                                                            ...
                                                                                                                                                                                            =
                                                                                                                                                                                            'd')),
  ('qwebsdfgv34vbh64756j0plmxzvnnkkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223369f343445289vjkb0011168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'), 3, '17:30', '18:30', TRUE, FALSE, TRUE, 'INTERMEDIATE', (SELECT
                                                                                                                                                                                                id
                                                                                                                                                                                              FROM
                                                                                                                                                                                                room
                                                                                                                                                                                              WHERE
                                                                                                                                                                                                ...
                                                                                                                                                                                                =
                                                                                                                                                                                                'd')),
  ('1468sdfgv34vbh64756j0plmxzvnnkkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '53223mcnv34344vb89vjgh05ggvcxv03'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '116789cnv65488vb110jgh05hjvcvv63'), 3, '19:30', '20:30', TRUE, FALSE, TRUE, 'INTERMEDIATE', (SELECT
                                                                                                                                                                                                id
                                                                                                                                                                                              FROM
                                                                                                                                                                                                room
                                                                                                                                                                                              WHERE
                                                                                                                                                                                                ...
                                                                                                                                                                                                =
                                                                                                                                                                                                'd')),
  ('2466sdfgv34vbh64756j0plmxzvnnkkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '53223mcnv34344vb89vjgh05ggvcxv03'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '116789cnv65488vb110jgh05hjvcvv63'), 3, '20:30', '21:30', FALSE, TRUE, FALSE, 'BEGINNER', (SELECT
                                                                                                                                                                                             id
                                                                                                                                                                                           FROM
                                                                                                                                                                                             room
                                                                                                                                                                                           WHERE
                                                                                                                                                                                             ...
                                                                                                                                                                                             =
                                                                                                                                                                                             'd')),
  ('3464sdfgv34vbh64756j0plmxzvnnkkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223299f343445289vjkb0011168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv11389vb89vjgh05hjvc8763'), 3, '20:30', '21:30', FALSE, TRUE, FALSE, 'BEGINNER', NULL),
  ('4466sdfgv34vbh64756j0plmxzvnnkkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223299f343445289vjkb50c1168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'), 3, '21:30', '22:30', FALSE, FALSE, TRUE, 'INTERMEDIATE', (SELECT
                                                                                                                                                                                                 id
                                                                                                                                                                                               FROM
                                                                                                                                                                                                 room
                                                                                                                                                                                               WHERE
  ...
  ('5466sd44v34vbh64756j0plmxzvnnkkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '53223mcnv34344vb89vjgh05hjvcxv03'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'), 4, '17:00', '17:45', TRUE, FALSE, TRUE, 'BEGINNER', (SELECT
                                                                                                                                                                                            id
                                                                                                                                                                                          FROM
                                                                                                                                                                                            room
                                                                                                                                                                                          WHERE
                                                                                                                                                                                            ...
                                                                                                                                                                                            =
                                                                                                                                                                                            'm')),
  ('5466sd44v34v73jd756j0plmxzvnnkkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '5322tycnv34344vb89vjgh05hjvcxv03'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '116789cnv65488vb110jgh05hjvcvv63'), 4, '19:15', '20:15', TRUE, FALSE, TRUE, 'BEGINNER', (SELECT
                                                                                                                                                                                            id
                                                                                                                                                                                          FROM
                                                                                                                                                                                            room
                                                                                                                                                                                          WHERE
                                                                                                                                                                                            ...
                                                                                                                                                                                            =
                                                                                                                                                                                            'd')),
  ('54839d44v34v73jd756j0plmxzvnnkkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '5322tycnv34344vb89vjgh05hjvcxv03'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '116789cnv65488vb110jgh05hjvcvv63'), 4, '20:15', '21:15', TRUE, FALSE, TRUE, 'INTERMEDIATE', (SELECT
                                                                                                                                                                                                id
                                                                                                                                                                                              FROM
                                                                                                                                                                                                room
                                                                                                                                                                                              WHERE
                                                                                                                                                                                                ...
                                                                                                                                                                                                =
                                                                                                                                                                                                'd')),
  ('54839d44kclv73jd756j0plmxzvnnkkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '5322tycnv34344vb89vjgh05hjvc1233'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv11389vb89vjgh05hjvc8763'), 4, '21:15', '22:15', FALSE, FALSE, TRUE, 'BEGINNER', (SELECT
                                                                                                                                                                                             id
                                                                                                                                                                                           FROM
                                                                                                                                                                                             room
                                                                                                                                                                                           WHERE
  ...
  ('73839d44kclv73jd756j0plmxzvnnkkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223369f343445289vjkb0011168103'), (SELECT
                                                                                            id
                                                                                          FROM instructor
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'), 5, '10:00', '11:00', TRUE, FALSE, TRUE, 'INTERMEDIATE', (SELECT
                                                                                                                                                                                                id
                                                                                                                                                                                              FROM
                                                                                                                                                                                                room
                                                                                                                                                                                              WHERE
                                                                                                                                                                                                ...
                                                                                                                                                                                                =
                                                                                                                                                                                                'd')),
  ('73hdjd44kclv73jd756j0plmxzvnnkkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43632299f343445289vjkb50c1168103'), NULL, 5, '11:00', '11:45',
   FALSE, TRUE, FALSE, 'BEGINNER', (SELECT
                                      id
                                    FROM room
                                    WHERE name = 'd')),
  ('03999d44kclv73jd756j0plmxzvnnkkk', (SELECT
                                          id
                                        FROM style
                                        WHERE sid = '43223299f343445289vjkb0011168103'), (SELECT
                                                                                            id
                                                                                          ...
                                                                                          WHERE sid =
                                                                                                '536789cnv34344vb89vjgh05hjvc1233'),
   5, '16:00', '17:00', FALSE, TRUE, FALSE, 'INTERMEDIATE', (SELECT
                                                               id
                                                             FROM room
                                                             WHERE name = 'd'));

INSERT INTO news (sid, title, created_at, content, image_src, image_alt) VALUES
  ('73hdjd44kclv73jd756j0plmxzvycuxk', 'Ooga Booga!', '2013-06-24 00:21',
   'Instruktorka z naszej szkoły - Barbara Karpińska podczas wczorajszego wrocławskiego turnieju tańca nowoczesnego dla dzieci i młodzieży "Ooga Booga" pełniła funkcję przewodniczącego jury :)<br/><br/>W szkole funkcjonuje formacja dziecięca, prowadzona przez Barbarę - od września ruszamy z kolejnym naborem dla nowych członków, w związku z czym zapraszamy dzieci w wieku 5-11 lat. Formacja bierze udział w licznych konkursach w kategorii Show dance oraz wielu pokazach. W najbliższym czasie nasze dzieciaki będziemy mogli podziwiać 14 lipca w Lwówku Śląskim podczas Lwóweckiego Lata Agatowego :)<br/><br/>Zapraszamy do oglądania galerii z wczorajszego turnieju.',
   'img/photos/oogabooga.jpg', 'konkurs tańca wrocław'),
...
--changeset pawel:5
UPDATE news
SET image_src = 'http://www.fit.pl/g/str/image/dziecko%20fit/ChildrenDancing.jpg'
WHERE sid = 'g55578jdkeenncamnn6j0plmxzvycjck';
